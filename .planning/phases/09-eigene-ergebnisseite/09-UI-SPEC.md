...
| Leerzustand unter einem Banner | Liste leer **und** ein Banner steht darüber | Der Leerzustand mit Suchbegriff entfällt. Nachgezogen am 09.09.2026 nach Befund A des Bug-Audits dieser Phase: "Keine Datei enthält „%s“" ist eine Aussage über eine Suche, die stattgefunden hat, und ist damit unwahr, sobald das Banner darüber sagt, dass sie gar nicht stattgefunden hat (Backend stumm, Versionsdrift, kein Home-Verzeichnis) oder nicht zu Ende ging (Obergrenze, Index im Aufbau). Beide Blöcke zusammen nennen dem Nutzer zwei verschiedene nächste Schritte, warten und umformulieren, und nur einer davon ist richtig. Der Leerzustand **ohne** Suchbegriff bleibt stehen: er ist eine Einladung und nie eine Behauptung |
