...
**FORTSCHREIBUNG 05.09.: im Kern ERLEDIGT.** Der Probelauf ist am 04.09. gefahren
(Lauf 33895862098, gruen): findling.tar.gz 223034 B/67 Eintraege,
findling_backend.tar.gz 26524 B/5, Artefakt store-release 251285 B inkl. beider
.sig, KEIN Release entstanden (wie entschieden). Drei dabei gefundene Fehler
sind behoben (ff4d805 Plattformunterschied, 353b678 openssl-Versionsdigest,
b0ac902 CR im Secret). Offen bleibt nur der Punkt aus DI-05-34.
...
**FORTSCHREIBUNG 05.09.:** Der Probelauf 33895862098 liefert die erste reale
Messzahl fuer die Laufdauer. Beim naechsten Anfassen von release.yml den Wert
gegen diese Messung setzen; bis dahin bleibt der Eintrag offen, aber entschaerft.
...
## DI-05-40 (Plan 05-21): Der ARM-Volllauf steht aus, weil cax11 nicht buchbar ist

*(Beim Merge am 05.09. von DI-05-32 auf DI-05-40 umnummeriert; die Nummern 32-34 waren durch Plan-05-18-Eintraege belegt. Querverweise in aelteren 05-21-Commits meinen diese Fassung.)*
...
## DI-05-41 (Plan 05-21): Der Workers-Vergleich ist ohne Produktaenderung nicht messbar

*(Beim Merge am 05.09. von DI-05-33 auf DI-05-41 umnummeriert; die Nummern 32-34 waren durch Plan-05-18-Eintraege belegt. Querverweise in aelteren 05-21-Commits meinen diese Fassung.)*
...
## DI-05-42 (Plan 05-21): Die Endkosten des AWS-Laufs sind gerechnet und nicht abgelesen

*(Beim Merge am 05.09. von DI-05-34 auf DI-05-42 umnummeriert; die Nummern 32-34 waren durch Plan-05-18-Eintraege belegt. Querverweise in aelteren 05-21-Commits meinen diese Fassung.)*
