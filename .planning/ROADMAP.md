...
- [x] 06-10-PLAN.md , Gate-Landschaft: kein zweiter Ausgang, Offline-Nachweis, Doku
...
- [x] 05-17-PLAN.md , Store-Metadaten dreisprachig, 1.0.0, Privacy, Textgate (PKG-05)
...
Plans:
- [ ] 06.1-01-PLAN.md , Welle 1 , Bewaffnung ueberlebt den Neustart (DI-05-36), mit Gegenprobe in CI
- [ ] 06.1-02-PLAN.md , Welle 1 , eine Embedding-Engine fuer Suchseite und Arbeiter statt zweier Instanzen
- [ ] 06.1-03-PLAN.md , Welle 1 , Checkpoint: die sechs Owner-Entscheidungen E-H1 bis E-H6
- [ ] 06.1-04-PLAN.md , Welle 2 , Wortlisten-Cache und die RSS-Ratsche als Dauerwaechter in CI
- [ ] 06.1-05-PLAN.md , Welle 1 , Randpfade der Extraktion: Encodings, falsche Endungen, Unicode-Namen
- [ ] 06.1-06-PLAN.md , Welle 3 , Randpfade im Korpus: Dekompressionsbombe und boesartige PDF-Strukturen
- [ ] 06.1-07-PLAN.md , Welle 1 , Paritaet um Papierkorb, Versionen, Link-Share und die Datei, die sich aendert
...
- [ ] 06.1-13-PLAN.md , Welle 4 , Store-Formalien: appstore-Pin, Bildgroessen, Kategorien, Vokabularregel
- [ ] 06.1-14-PLAN.md , Welle 4 , OCR fuer DACH: Zeichenfehlerrate und die Fraktur-Option
- [ ] 06.1-15-PLAN.md , Welle 5 , Gastnutzer-Probe und die Gate-Landschaft; Plan 05-19 aufgeloest
- [ ] 06.1-16-PLAN.md , Welle 4 , Fremdinstallation auf frischer Instanz nach E-H5, amd64 und die Nichtabdeckung
