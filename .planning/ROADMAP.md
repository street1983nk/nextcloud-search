...
- [x] 22-03-PLAN.md: 94c (Bodensatz-Zyklus 2), 95c (Kaltstart mit Trefferpflicht), 98d (dismax-Probe) mit Unit-Test
- [x] 22-04-PLAN.md: 00-wegwerf.sh (B3, B5, B4) und 00-typwechsel.sh (Shutdown-Vorprüfung, m7g.4xlarge)
...
- [x] 22-06-PLAN.md: Generalprobe lokal, Owner-Freigabe Push, W4-Lauf in CI, F4 und B7

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 22-07-PLAN.md: Rechenblatt, Owner-Checkpoint (44/6-Weg, Deckelvariante, dismax-Regel), Antworten einfrieren

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 22-08-PLAN.md: Vorbedingungen, Aufbau, unbeaufsichtigter Lauf mit hartem Timer, Abholen bis zur Selbstabschaltung

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 22-09-PLAN.md: B4 auf m7g.4xlarge oder begründeter Entfall, Abbau, Kosten gegen Deckel, Lückenbericht

**Wave 7** *(blocked on Wave 6 completion)*

- [x] 22-10-PLAN.md: MESS-09-Entscheid nach E10, dismax umgesetzt (rewrite.py, Ratsche) oder dokumentiert verworfen
