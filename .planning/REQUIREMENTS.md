...
- [x] **ADM-02**: Pro-Datei-Diagnose: Admin kann für jede Datei sehen, warum sie (nicht) auffindbar ist (zu groß, Typ nicht unterstützt, OCR fehlgeschlagen, wartet in Queue)
- [x] **ADM-03**: Vorab-Schätzung vor dem Erstindex: X Dateien, davon Y OCR-nötig, geschätzte Dauer und Platz
