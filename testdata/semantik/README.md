...
126 Paare aus einer Umschreibung und dem Abschnitt, den sie meint: 42 auf
Deutsch, 42 auf Englisch, 42 auf Französisch. Sie beantworten zwei Fragen, die
...
**Ablenkermenge**: jede Anfrage konkurriert gegen alle übrigen 41 Abschnitte
derselben Datei. Eine zweite Liste gibt es deshalb nicht, und sie kann folglich
...
| `fr.jsonl` | 42 | Französisch, mit echten Akzenten und Cedille |
...
sonst von dem weg, was sie zählt.
